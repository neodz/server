...
@section('content')
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="{{ __('Phone') }}" name="phone" value="{{ old('phone') }}" required >
                    </div>
    ...
    @else
    <h1>Sorry !! log in with super admin to create new admin </h1>

    <h2> click <a class="dropdown-item" href="{{ route('logout') }}"
       onclick="event.preventDefault();
       document.getElementById('logout-form').submit();">{{ __('HERE') }}
        </a>  to go back</h2>
